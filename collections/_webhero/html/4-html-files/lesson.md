...
## HTML Boilerplate
Remember the HTML boilerplate introduced in [lesson #1]({% link _webhero/html/1-intro-to-html/lesson.md %})? We're going to add it to the HTML file you created.<br>
